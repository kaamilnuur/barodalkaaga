...
public class bakooladapter  extends RecyclerView.Adapter<bakooladapter.myviewholder> {
    private ArrayList<degmamodel> degmamodelArrayList;
    Context context;

    public bakooladapter(ArrayList<degmamodel> degmamodelArrayList, Context context) {
