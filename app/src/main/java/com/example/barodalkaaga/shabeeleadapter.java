...
public class shabeeleadapter  extends RecyclerView.Adapter<shabeeleadapter.myviewholder> {

    private ArrayList<degmamodel >degmamodelArrayList;
    Context context;

    public shabeeleadapter(ArrayList<degmamodel> degmamodelArrayList, Context context) {
