...
public class sooladapter extends RecyclerView.Adapter<sooladapter.myviewholder> {
    private ArrayList<degmamodel>degmamodelArrayList;
    Context context;

    public sooladapter(ArrayList<degmamodel> degmamodelArrayList, Context context) {
    ...
    public class myviewholder extends RecyclerView.ViewHolder {
        ...
        public myviewholder(@NonNull View itemView) {
            super(itemView);
            degma=itemView.findViewById(R.id.recyclerview_degma);
        }
    }
}
