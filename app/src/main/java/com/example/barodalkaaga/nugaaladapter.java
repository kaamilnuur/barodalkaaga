...
public class nugaaladapter extends RecyclerView.Adapter<nugaaladapter.myviewholder> {
    private ArrayList<degmamodel>degmamodelArrayList;
    Context context;

    public nugaaladapter(ArrayList<degmamodel> degmamodelArrayList, Context context) {
