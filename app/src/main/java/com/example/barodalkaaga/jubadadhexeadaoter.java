...
public class jubadadhexeadaoter extends RecyclerView.Adapter<jubadadhexeadaoter.myviewholder> {
    private ArrayList<degmamodel> degmamodelArrayList;
    Context context;

    public jubadadhexeadaoter(ArrayList<degmamodel> degmamodelArrayList, Context context) {
