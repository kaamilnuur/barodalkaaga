...
public class shabeeladhexe  extends RecyclerView.Adapter<shabeeladhexe.myviewholder> {
    private ArrayList<degmamodel>degmamodelArrayList;
    Context context;

    public shabeeladhexe(ArrayList<degmamodel> degmamodelArrayList, Context context) {
    ...
    @NonNull
    @Override
    public shabeeladhexe.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull shabeeladhexe.myviewholder holder, int position) {
