...
public class gedoadapter  extends RecyclerView.Adapter<gedoadapter.myviewholder> {
    private ArrayList<degmamodel>degmamodelArrayList;
    Context context;

    public gedoadapter(ArrayList<degmamodel> degmamodelArrayList, Context context) {
