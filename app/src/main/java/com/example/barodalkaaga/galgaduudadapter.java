...
public class galgaduudadapter  extends RecyclerView.Adapter<galgaduudadapter.myviewholder> {

    private ArrayList<degmamodel>degmamodelArrayList;
    Context context;

    public galgaduudadapter(ArrayList<degmamodel> degmamodelArrayList, Context context) {
