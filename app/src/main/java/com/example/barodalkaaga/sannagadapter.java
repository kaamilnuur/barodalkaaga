...
public class sannagadapter extends RecyclerView.Adapter<sannagadapter.myviewholder> {
    private ArrayList<degmamodel>degmamodelArrayList;
    Context context;

    public sannagadapter(ArrayList<degmamodel> degmamodelArrayList, Context context) {
    ...
    @NonNull
    @Override
    public sannagadapter.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull sannagadapter.myviewholder holder, int position) {
