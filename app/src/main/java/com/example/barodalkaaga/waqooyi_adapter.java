...
public class waqooyi_adapter extends RecyclerView.Adapter<waqooyi_adapter.myviewholder> {
    private ArrayList<degmamodel>degmamodelArrayList;
    Context context;

    public waqooyi_adapter(ArrayList<degmamodel> degmamodelArrayList, Context context) {
