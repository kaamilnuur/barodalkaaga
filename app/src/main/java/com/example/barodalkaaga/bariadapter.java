...
public class bariadapter extends RecyclerView.Adapter<bariadapter.myviewholder> {
    private ArrayList<degmamodel>degmamodelArrayList;
    Context context;

    public bariadapter(ArrayList<degmamodel> degmamodelArrayList, Context context) {
